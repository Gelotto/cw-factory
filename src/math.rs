...
//! ## Purpose
//!
//! All arithmetic in smart contracts should use checked operations to prevent
//! overflow/underflow bugs. This module provides type-generic wrappers around
//! CosmWasm's checked arithmetic with proper error handling.
//!
//! ## Operations Provided
//!
//! For each numeric type (u32, Uint64, Uint128, Uint256, Int256):
//! - `add_*`: Checked addition
//! - `sub_*`: Checked subtraction
//! - `mul_*`: Checked multiplication (where applicable)
//! - `div_*`: Checked division (where applicable)
//! - `mul_ratio_*`: Checked (base * numerator / denominator) for proportional calculations
//!
//! ## Use Cases
//!
//! - Counter increments: `add_u32(counter, 1)` for migration success/error counts
//! - ID generation: `add_u64(reply_id_counter, 1)` for unique IDs
//! - Proportional calculations: `mul_ratio_*` for fee distributions
