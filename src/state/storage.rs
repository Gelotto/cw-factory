...
use super::models::{Migration, MigrationError, Preset, SubMsgContext};
...
pub const IX_REL_CONTRACT_ADDR: Map<(ContractId, &[u8], &[u8]), Option<IndexValue>> = Map::new("ix_rel_contract_addr");
